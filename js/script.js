...
(function () {
    ...
    (function() {
        ...
        function initCountdown() {
            ...
            // Se não há tempo de início armazenado, cria um novo
            if (!startTime) {
                startTime = Date.now();
            ...
            function updateCountdown() {
                ...
                const remainingSeconds = Math.max(0, COUNTDOWN_DURATION - elapsedSeconds);
                ...
                const progressPercent = (elapsedSeconds / COUNTDOWN_DURATION) * 100;
                const progressFill = document.getElementById('urgencyFill');
                if (progressFill) {
                    progressFill.style.width = Math.min(progressPercent, 100) + '%';
                }
                
                // Se chegou a zero, reseta para um novo ciclo
...
✓ Quando chega a zero, reseta automaticamente para um novo ciclo de 15 minutos
✓ O tempo é armazenado em localStorage (específico do navegador dela)
✓ Usa apenas JavaScript, sem dependências externas
